...
function IolSection() {
    ...
    const recStyles = {
        ...
        none:      { bg: 'bg-red-100', border: 'border-red-400', text: 'text-red-700' }
    };
        ...
        <section className="max-w-2xl mx-auto space-y-6">
            ...
            <div className="space-y-3">
                ...
                {currentGroup.map(iol => {
                    const rec = currentRecs[iol.id] || '';
                    return (
                        <div key={iol.id} className={`glass-card p-5 transition-all duration-200 ${rec === 'recommend' ? 'ring-2 ring-green-400 bg-green-50/30' : rec === 'possible' ? 'ring-1 ring-orange-400 bg-orange-50/30' : rec === 'none' ? 'ring-1 ring-red-400 bg-red-50/30' : ''}`}>
