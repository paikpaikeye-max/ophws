        ...
        <div className="assistant-body">
            ...
            <main className="content-area">
                <div className="animate-fade-in space-y-8">
                    ...
                    {activeTab === 'iol' && (
                        <div className="flex flex-col items-center justify-center h-[60vh] text-slate-400 space-y-6 animate-fade-in bg-white rounded-3xl border border-slate-200 shadow-sm p-10 text-center">
                            <i className="fa-solid fa-person-digging text-6xl text-slate-300"></i>
                            <div>
                                <h2 className="text-2xl font-black text-slate-600 mb-2">추후 구현 예정입니다.</h2>
                                <p className="text-sm font-bold text-slate-400">환자 맞춤 인공수정체 안내문 기능이 곧 업데이트 될 예정입니다.</p>
                            </div>
                        </div>
                    )}
                </div>
