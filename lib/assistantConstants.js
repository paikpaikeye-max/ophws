...
export const ASSISTANT_FEATURE_REGISTRY = [
    ...
    },
    {
        ...
        deployOptions: [
            { id: "visibility", label: "기능 사용 상태", description: "이 기능을 좌측 툴바에 보이게 할지 기본값을 정합니다." },
            { id: "content", label: "안내문 문구", description: "각 렌즈별 장점, 단점, 적합한 분 문구의 기본값을 배포합니다." },
            { id: "pricing", label: "가격 출력", description: "가격 출력 여부와 렌즈별 가격 기본값을 배포합니다." },
            { id: "printStyle", label: "인쇄 스타일", description: "흑백 인쇄 최적화 같은 출력 스타일 기본값을 배포합니다." },
        ],
        settingSourceHint: "현재는 표시 여부, 렌즈별 문구, 가격 정보, 인쇄 스타일을 계정별로 저장합니다.",
        supportsExternalPreset: false,
    },
    {
        id: "rare-gene",
        navLabel: "유전자검사지원사업",
        settingsTabId: "rare-gene-set",
        settingsTitle: "유전자검사지원사업",
        icon: "fa-dna",
        deployOptions: [
            { id: "visibility", label: "기능 사용 상태", description: "이 기능을 메뉴에서 보일지 기본값으로 설정합니다." },
        ],
        settingSourceHint: "현재는 메뉴 노출 여부만 계정별로 저장됩니다.",
        supportsExternalPreset: false,
    },
];
